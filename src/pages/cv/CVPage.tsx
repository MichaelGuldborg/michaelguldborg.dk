    ...
    experience: [
        {
            ...
            bullets: [{
                ...
                description: "Built and owned the complete mobile and web CI/CD pipeline: automated builds via GitHub Actions, and managed App Store (iOS) and Google Play (Android) release processes end-to-end."
            }, {
                title: "Data driven development",
                description: "Improved react-native and web app experience based on data and user feedback, leading to a 20% reduction in support tickets"
            }, {
    ...
    projects: [
        {
            name: "Workout",
            period: "2025 - Present",
            description: "A personal fitness tracking app built with React Native and Expo in spare time. Features workout logging, progress tracking, and a clean mobile-first UI.",
            link: "https://workout.michaelguldborg.dk",
            androidLink: "https://play.google.com/apps/testing/dk.michaelgudborg.workout",
            iosLink: "https://testflight.apple.com/join/nyy4Q2ae"
        },
        {
            name: "CitySurfing",
            period: "2021",
                        ...
                        <Grid item xs={12} md={8}>
                            ...
                            <Box sx={{display: 'flex', flexWrap: 'wrap', gap: 2}}>
                                ...
                                <Box sx={{
                                    ...
                                    <Link href={`tel:${data.personalInfo.phone.replace(/\s/g, '')}`} color="inherit"
                                          underline="hover">
                                ...
                                <Box sx={{
                                    ...
                                    <Link href={`https://${data.personalInfo.website}`} target="_blank" color="inherit"
                                          underline="hover">
                                ...
                                <Box sx={{
                                    ...
                                    <Link href={`https://${data.personalInfo.linkedin}`} target="_blank" color="inherit"
                                          underline="hover">
                                ...
                                <Box sx={{
                                    ...
                                    <Link href={`https://${data.personalInfo.github}`} target="_blank" color="inherit"
                                          underline="hover">
                                ...
                                <Grid container justifyContent="space-between" alignItems="flex-start">
                                    <Grid item xs={12} sm={8}>
                                        <Typography variant="subtitle1"
                                                    sx={{fontWeight: 700, color: theme.colors.black}}>
                                            {exp.role}
                                        </Typography>
                                    ...
                                    <Grid item xs={12} sm={4} sx={{textAlign: {sm: 'right'}}}>
                                        <Typography variant="body2"
                                                    sx={{color: theme.colors.textGrey, fontWeight: 500}}>
                                            {exp.period}
                                        </Typography>
                                    </Grid>
                                </Grid>
                                    ...
                                    <Box component="ul" sx={{mt: 1, pl: 2, color: theme.colors.darkGrey}}>
                                        {exp.bullets.map((bullet, bIndex) => (
                                            <Box component="li" key={bIndex} sx={{mb: 0.5}}>
                                                <Typography variant="body2"
                                                            sx={{color: theme.colors.darkGrey, lineHeight: 1.6}}>
                                                    <Box component="span" sx={{
                                                        fontWeight: 600,
                                                        color: theme.colors.black
                                                    }}>{bullet.title}:</Box> {bullet.description}
                                                </Typography>
                                            </Box>
                                        ))}
                                    </Box>
                                    ...
                                    <Grid item>
                                        ...
                                        {proj.link && (
                                            <Link href={proj.link} target="_blank" rel="noopener" underline="hover"
                                                ...
                                                <GlobalLineIcon size={14}/>
                                                <Typography
                                                    variant="body2">{proj.link.replace('https://', '')}</Typography>
                                            </Link>
                                        )}
                                        {proj.androidLink && (
                                            <Link href={proj.androidLink} target="_blank" rel="noopener"
                                                  underline="hover" sx={{
                                                display: 'flex',
                                                alignItems: 'center',
                                                gap: 0.5,
                                                ...
                                                <GlobalLineIcon size={14}/>
                                                <Typography variant="body2">Google Play (Beta)</Typography>
                                            </Link>
                                        )}
                                        {proj.iosLink && (
                                            <Link href={proj.iosLink} target="_blank" rel="noopener"
                                                  underline="hover" sx={{
                                                display: 'flex',
                                                alignItems: 'center',
                                                gap: 0.5,
                                                ...
                                                <GlobalLineIcon size={14}/>
                                                <Typography variant="body2">TestFlight (iOS Beta)</Typography>
                                            </Link>
                                        )}
                                    </Grid>
                                    <Grid item>
